...
if($topicvalue != null && $title == null && $body == null){
    $sql = $conn->query("SELECT BLOG_ID, BLOG_TITLE FROM $table1 WHERE BLOG_TOPIC LIKE '%$topicvalue%'");
    ...
    $sql = $conn->query("SELECT BLOG_ID, BLOG_TITLE FROM $table1 WHERE BLOG_TITLE LIKE '%$title%'");
    ...
    $sql = $conn->query("SELECT BLOG_ID, BLOG_TITLE FROM $table1 WHERE BLOG_BODY LIKE '%$body%'");
    ...
    $sql = $conn->query("SELECT BLOG_ID, BLOG_TITLE FROM $table1 WHERE BLOG_TOPIC LIKE '%$topicvalue%' AND BLOG_TITLE LIKE '%$title%'");
    ...
    $sql = $conn->query("SELECT BLOG_ID, BLOG_TITLE FROM $table1 WHERE BLOG_TOPIC LIKE '%$topicvalue%' AND BLOG_BODY LIKE '%$body%'");
 ...
 BLOG_TITLE LIKE '%$title%'");
    ...
    $sql = $conn->query("SELECT BLOG_ID, BLOG_TITLE FROM $table1 WHERE BLOG_BODY LIKE '%$body%' AND BLOG_TITLE LIKE '%$title%'");
    ...
    $sql = $conn->query("SELECT BLOG_ID, BLOG_TITLE FROM $table1");
